...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_logic__Game_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_logic__Game_t qt_meta_stringdata_logic__Game = {
    {
QT_MOC_LITERAL(0, 11) // "logic::Game"
...
const QMetaObject logic::Game::staticMetaObject = { {
    ...
    qt_meta_stringdata_logic__Game.offsetsAndSize,
    qt_meta_data_logic__Game,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_logic__Game_t
...
void *logic::Game::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_logic__Game.stringdata0))
