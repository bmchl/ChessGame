...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_CalcWindow_t, stringdata0) + ofs), len 
...
const QMetaObject CalcWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CalcWindow.offsetsAndSize,
    qt_meta_data_CalcWindow,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_CalcWindow_t
